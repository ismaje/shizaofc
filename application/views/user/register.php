...
>
  <head>
    ...
    <title>Shiza Official(user) - Register</title>
    ...
    <div class="container-xxl">
      ...
      <div class="authentication-wrapper authentication-basic container-p-y">
        <div class="authentication-inner">
          ...
          <div class="card col-22 col-md-22 col-lg-22">
            <div class="card-body">
              <!-- Logo -->
              <div class="app-brand justify-content-center">
                <a href="index.html" class="app-brand-link gap-2">
                  ...
                  <span class="app-brand-text demo text-body fw-bolder">REGISTER USER</span>
                </a>
              </div>
              <!-- /Logo -->
                ...
                <?php endif ?> -->
                  <form method="POST" action="<?php echo site_url('user/save');?>">
                    <div class="row">
                      ...
                      <input id="nama_costumer" type="text" class="form-control" name="nama_costumer" tabindex="1" required autofocus>
                      </div>
                      <div class="form-group col-6">
                    ...
                    <div class="form-group col-12">
                      ...
                      <div class="form-group">
                        <div class="d-block">
                      <button type="submit" class="btn btn-primary d-grid w-100" tabindex="4">
                        Register
                      </button>
                    </div>
                    </div>
