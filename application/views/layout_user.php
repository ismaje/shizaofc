				...
				<div class="col-lg-3 col-md-6">
					<div class="footer-box get-in-touch">
						...
						<ul>
							...
							<li>Indonesia</li>
							<li><a href="https://wa.me/085700804799?text=Hii">085 700 804 799</a></li>
						</ul>
					</div>
				</div>
				<div class="col-lg-3 col-md-6">
		...
		<div class="container">
			<div class="row">
				<div class="col-lg-6 col-md-12">
					<p>Copyrights &copy; 2020 - <a href="https://www.instagram.com/shizaofficial_/">Shiza Officla</a>,  All Rights Reserved.</p>
				</div>
