      ...
      <div class="layout-container">
        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
          ...
          <ul class="menu-inner py-1">
            <!-- Dashboard -->
            <li class="menu-item">
              <a href="<?php echo site_url('adminpanel/dashboard');?>" class="menu-link">
            ...
            <li class="menu-item">
              <a href="<?php echo site_url('produk');?>" class="menu-link">
            ...
            <li class="menu-item">
              <a href="<?php echo site_url('detailorder');?>" class="menu-link">
                <i class="menu-icon tf-icons bx bx-package"></i>
                <div data-i18n="Analytics">Detail Order</div>
              </a>
            </li>
            <li class="menu-item">
                ...
                <li class="nav-item navbar-dropdown dropdown-user dropdown">
                  <a class="nav-link dropdown-toggle hide-arrow" href="javascript:void(0);" data-bs-toggle="dropdown">
                    <div class="avatar avatar-online">
                      <img src="<?php echo base_url('assets/img/1.png'); ?>" alt class="w-px-40 h-auto rounded-circle" />
                    </div>
                  </a>
